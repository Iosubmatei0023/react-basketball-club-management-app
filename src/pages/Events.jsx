...
const Events = () => {
  ...
  const futureEvents = [
    {
      ...
      description:
        "High-energy games featuring the most talented young basketball players.",
      image:
        "https://brooklynbridgeparents.com/wp-content/uploads/2024/02/BBA-Feature-Image-800x600.jpg",
      button: {
        text: "Join Event",
        color: "orange",
      },
    },
    {
      ...
      description:
        "Free-entry basketball fun to get kids moving and loving the game!",
      image:
    ...
    },
    {
      ...
      description:
        "An open-air gathering for basketball lovers of all ages to play, connect, and share the passion.",
      image:
        "https://www.hastingsjournal.news/uploads/original/20240829-145227-8c3-IMG_0023.jpg",
      button: {
        text: "Join Event",
        color: "orange",
      },
    },
    {
      ...
      description:
        "Enter for a chance to experience NBA action live in Paris — courtside thrills, superstar moments, and unforgettable memories!",
      image:
        "https://t3.ftcdn.net/jpg/10/04/56/74/360_F_1004567472_Yt2hqQCeHDpxGHvp7BLB9s4eDAEfYonG.jpg",
      button: {
        text: "Join Event",
        color: "orange",
      },
    },
    {
      ...
      description:
        "Cheer on the juniors as they take their first step towards greatness.",
      image:
        "https://houseofbasketball.org/wp-content/uploads/2023/11/campz.webp",
      button: {
        text: "Join Event",
        href: "#",
        color: "orange",
    ...
    },
    {
      ...
      description:
        "Subscribe to our newsletter to stay updated on future events and exclusive opportunities!",
  ...
  const pastEvents = [
    {
      ...
      description:
        "A week full of drills, games, and teamwork to take your basketball to the next level.",
      image:
        "https://cdn.nba.com/teams/uploads/sites/1610612749/2022/05/EO1Y0RVX4AEO-EK.jpg",
      button: {
        text: "View Details",
        href: "#",
        color: "blue",
    ...
    },
    {
      ...
      date: "July 2, 2025",
      description:
        "A memorable moment with the Legends — autographs, smiles, and inspiration.",
      image:
        "https://cdn.nba.com/teams/legacy/www.nba.com/suns/sites/suns/files/legacy/photos/autograph11_0.jpg",
      button: {
        text: "View Details",
        color: "blue",
      },
    },
    {
      ...
      date: "June 28, 2025",
      description:
        "Join us on the court and prove your skills — your journey to the team starts here.",
      image:
        "https://www.onpointbasketball.com/wp-content/uploads/2019/09/IMG-20190907-WA0013.jpg",
      button: {
        text: "View Details",
        href: "#",
        color: "blue",
    ...
    },
    {
      ...
      date: "June 16, 2025",
      description:
        "The minds and mentors guiding our club on and off the court.",
      image:
        "https://images.gametime.co/sport/other/gametime-images/otherunrivaled/hero@4x/unrivaled-basketball-league.jpg?auto=webp&format=pjpg&disable=upscale&dpr=2&fit=crop&width=440&quality=50%2C35&height=200",
      button: {
        text: "View Details",
        href: "#",
        color: "blue",
  ...
  const handleJoinEvent = async (event) => {
    ...
    try {
      ...
      if (joinedEvent) {
        setPopoutMessage(
          `You already joined this event on ${joinedEvent.date}`
        );
        setPopoutOpen(true);
        return;
      }
      ...
      const updated = [
        ...scheduledEvents,
        { eventName: event.title, date: event.date },
      ];
      await updateDoc(docRef, { scheduledEvents: updated });
      // Re-fetch to confirm
      docSnap = await getDoc(docRef);
      scheduledEvents = docSnap.exists()
        ? docSnap.data().scheduledEvents || []
        : [];
  ...
  return (
    <div className="events-page">
      ...
      />
      <NewsletterPopout
        open={newsletterPopoutOpen}
        onClose={() => setNewsletterPopoutOpen(false)}
      />
      <DetailsPopout
        open={detailsPopoutOpen}
        onClose={() => setDetailsPopoutOpen(false)}
        title={detailsPopoutTitle}
        details={detailsPopoutDetails}
      />
      <EventsNavbar />
          ...
          {futureEvents.slice(0, 3).map((event, index) => (
            <div
              ...
              className={`event-card ${
                event.button?.color === "blue" ? "blue" : "orange"
              }`}
            >
              ...
              <div className="event-content">
                ...
                {event.button?.color === "orange" &&
                event.button?.text === "Join Event" ? (
                  <button
                    className={`event-button orange`}
                    ...
                    onClick={async () => {
                      if (user && user.uid) {
                        try {
                          ...
                          if (docSnap.exists()) {
                            newsletterJoined =
                              !!docSnap.data().newsletterJoined;
                          }
                          if (newsletterJoined) {
                            setPopoutMessage(
                              "You have already joined our newsletter."
                            );
                            setPopoutOpen(true);
                            return;
                          }
                          ...
                          // Re-fetch to confirm
                          docSnap = await getDoc(docRef);
                          newsletterJoined = docSnap.exists()
                            ? !!docSnap.data().newsletterJoined
                            : false;
                          setPopoutMessage(
                            newsletterJoined
                          ...
                          setPopoutMessage(
                            "Failed to join the newsletter. Please try again."
                          );
                          setPopoutOpen(true);
                        }
                      } else {
                        setPopoutMessage(
                          "Please log in to join the newsletter."
                        );
                        setPopoutOpen(true);
                      }
                    }}
